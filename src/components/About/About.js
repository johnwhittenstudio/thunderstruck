...
import logo10 from './../img/logos/10.png'
// import tst01 from './../img/trips/tst_01.jpg'
      ...
      <div className={classes.Container}>
        <div className={classes.Logos}>
          ...
          {/* <div className={classes.blockColRight}>
            <img className={classes.tst01} src={tst01} alt="me"></img>
          </div> */}
